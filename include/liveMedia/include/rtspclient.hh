...
public:
  ...
  Boolean isCoshipServer() const {return fServerIsCoship;}
  Boolean isfMDN_HWPSS()   const {return fServerIsMDN_HWPSS;}
...
private:
  ...
  Boolean fServerIsCoship;
  Boolean fServerIsMDN_HWPSS;
};
