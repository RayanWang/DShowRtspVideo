...
::nextEnclosedFrameSize(unsigned char*& framePtr, unsigned dataSize) {
  ...
  int      laseNeedLen;
	...
	laseNeedLen = fLastNeedLen;

  if (laseNeedLen)
  {
	  fLastNeedLen = 0;
	  return (laseNeedLen<=dataSize)?laseNeedLen:dataSize;
  }
#endif
...
#if 0
  fLastNeedLen = resultFrameSize-dataSize;
	//return (resultFrameSize <= dataSize) ? resultFrameSize : 0;
 // return dataSize;//modify by jiok
#endif
